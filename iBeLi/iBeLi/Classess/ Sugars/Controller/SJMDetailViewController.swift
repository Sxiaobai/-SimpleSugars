...
class SJMDetailViewController: SJMBaseViewController {
    ...
    override func viewDidLoad() {
        ...
        // "http://dantang.liwushuo.com/posts/ +\(homeItem?.id) /content"
...
extension SJMDetailViewController: UIWebViewDelegate {
