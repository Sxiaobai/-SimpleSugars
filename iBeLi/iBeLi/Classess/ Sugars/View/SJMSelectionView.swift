...
class SJMSelectionView: UICollectionViewCell {
    ...
    lazy var headView: XTADScrollView = {
        let headView = XTADScrollView.init(frame: CGRectMake(0, 0, SCREEN_W, 120))
    ...
    func loadData() -> Void {
        ...
        SJMBannersModel.bannerrequestData { (banner, error) in
            if error == nil {
...
extension SJMSelectionView: UITableViewDelegate, UITableViewDataSource {
